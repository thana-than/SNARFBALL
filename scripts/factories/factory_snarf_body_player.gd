...
var default_settings = preload("res://settings/DefaultSnarfBodySettings.tres")


#* Instantates a snarf_body entity with player controls, settings, and indentifier
func instantiate(player_index: int, device_id: int, body_settings: SnarfBodySettings = default_settings):
	...
	snarf_body.settings = body_settings
